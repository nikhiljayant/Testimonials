...
const Testimonials = ({ reviews }) => {
    ...
    return (
        ...
        items-center mt-10 p-10 transition-all duration-700 hover:shadow-xl rounded-md'>
            ...
            <div>
                <button onClick={surpriseHandler} className='bg-violet-400 hover:bg-violet-500 transition-all duration-200 cursor-pointer px-10 py-2 rounded-md font-bold text-white text-lg mt-8'>
                    Suprise Me
                </button>
            </div>
        </div>
